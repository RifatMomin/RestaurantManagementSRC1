...
<html ng-app="restaurantApp">
    ...
    <body ng-controller="restaurantController as restCtrl" ng-init="checkUserType();getUserInfo();getRestaurantInfo();loadProvinces()">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" ng-click="action = 5; resetImage()" data-toggle="modal" data-target="#myDataModal"><span class="glyphicon glyphicon-user"></span>{{userLoggedIn.username}}</a></li>
