...
require_once "../model/persist/TablesADO/TableStatusADO.php";
...
class TableController implements ControllerInterface {
    ...
    function __construct($action, $jsonData) {
        ...
        $this->helperStatusAdo = new TableStatusADO();
    }
    ...
    /*
     * @name addNewTable
     * @description adds a new table to db
     * @version 1
     * @author Rifat Momin
     * @date 2016/05/23
     */
    ...
    /*
     * @name updateTable
     * @description updates table to db
     * @version 1
     * @author Rifat Momin
     * @date 2016/05/23
     */
    ...
    public function updateTable() {
        ...
        if ($result->rowCount() > 0) {
            ...
            $this->data [] = false;
            $this->errors[] = "Can't update table right now. Try later.";
            $this->data [] = $this->errors;
        }
    }

    /*
     * @name getAllTablesStatus
     * @description retrieves all table status from db
     * @version 1
     * @author Rifat Momin
     * @date 2016/05/23
     */
